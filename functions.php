...
function peacock_adding_styles() {
	wp_register_style('peacock_stylesheet', get_template_directory_uri() .'/assets/css/peacock-style.css', array(), '1.5' );
...
function peacock_adding_scripts() {
	wp_register_script('peacock_script', get_template_directory_uri() . '/assets/js/all.js', array('jquery'),'1.2', true);
